    ...
    <footer className="fixed bottom-0 left-0 md:left-64 right-0 bg-blue-900 text-white py-1 sm:py-2 px-3 sm:px-6 text-xs sm:text-sm md:text-base">
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center">
        <div className="mb-1 sm:mb-0 text-center sm:text-left">
          <p className="hidden sm:inline">&copy; 2026 </p>
          <Link
            to="home"
            smooth={true}
            duration={500}
        ...
        <div className="mb-1 sm:mb-0 text-center">
          <a
            href="/privacy-policy"
            className="text-blue-400 hover:text-blue-300 mx-1 sm:mx-2 transition-colors"
          >
        ...
        <div className="flex justify-center sm:justify-end space-x-3 items-baseline">
          <a
